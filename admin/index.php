				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								//tinh thong so phan trang
								$total_rows = $db->count('tintuc');
								$per_page = 5;
								if (isset($_GET['page']))
								{
									$page = $_GET['page'];
								...
								else
								{
									...
									$showAll = $db->displayAll($page, $per_page);
									foreach ($showAll as $row) {	
								?>	
							<tr class="">
								<td><img src="../public/images/<?php echo $row['hinhAnh'] ?>" style="width: 400px;height: 100px;"/></td>
								...
								<td>
									...
									<a href="delete-news.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-mini">Delete</a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
