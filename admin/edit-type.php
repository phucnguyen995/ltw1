...
$protype = new newsprotype();
	...
	if (isset($_POST['editTL']))
	{
		...
		$idTL = $_GET['idTL'];
		$protype->editTheLoai($type_name, $idTL);
						...
						<form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								...
								<div class="controls">
									<?php
									$idTL = $_GET['idTL'];
									$showType = $protype->infor_editTheLoai($idTL);
								?>
									<input type="text" class="span11" placeholder="Type name" value="<?php echo $showType['tenTL'] ?>" name="type_name" /> *
								</div>
							</div>
								<div class="form-actions">
									<button type="submit" class="btn btn-success" name="editTL">Edit</button>
								</div>
							</div>
