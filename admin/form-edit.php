			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="xuly_edit.php?id=<?php echo $id ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
							<?php
							
							 $infor = $protype->infor_edit($id); 
							 ?>
							<div class="control-group">
								<label class="control-label">Tiêu đề :</label>
								<div class="controls">
									<input type="text" class="span11" placeholder="Title" name="tieuDe" value="<?php echo $infor['tieuDe'] ?>" /> *
								</div>
							</div>
							<div class="control-group">
									<label class="control-label">Choose an image :</label>
									<div class="controls">
										<input type="file" name="hinhAnh" id="fileUpload">
									</div>
							</div>
							<div class="control-group">
									<label class="control-label"  >Content</label>
									<div class="controls">
										<textarea class="span11" placeholder="Content..." name = "noiDung" ><?php echo $infor['noiDung'] ?></textarea>*
									</div>
									<div class="control-group">
										<label class="control-label">Time :</label>
										<div class="controls">
											<input type="text" class="span11" placeholder="Time" name = "time" value="<?php echo $infor['time'] ?>" /> *
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">Author :</label>
										<div class="controls">
											<input type="text" class="span11" placeholder="author" name = "author" value="<?php echo $infor['author'] ?>" /> *
										</div>
									</div>
								<div class="control-group">
									...
									<div class="controls">
										<select name="idTL">
											<option value="<?php echo $infor['idTL'] ?>">Thể loại cũ : <?php echo $infor['tenTL'] ?></option>
											<?php 
								...
								<div class="control-group">
									...
									<div class="controls">
										<select name="tinnoibat" ria-required="true" required="required" >
											<option selected = "selected" value="<?php echo $infor['tinnoibat'] ?>">Mặc định lựa chọn cũ : <?php echo $infor['tinnoibat'] ?> </option>
