				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									$showType = $protype->getNewsType();
									foreach ($showType as $row) {
								?>
							<tr class="">
								<td><?php echo $row['idTL'] ?></td>
								<td><?php echo $row['tenTL'] ?></td>
								<td>
									<a href="edit-type.php?idTL=<?php echo $row['idTL'] ?>&tenTL=<?php echo $row['tenTL'] ?>" class="btn btn-success btn-mini">Edit</a>
									<a href="delete-type.php?idTL=<?php echo $row['idTL'] ?>" class="btn btn-danger btn-mini">Delete</a>
								</td>
							</tr>
							<?php } ?>
							</tbody>
