...
<html lang="en">
	...
	<body>
		...
		<div id="owl-carousel-1" class="owl-carousel owl-theme center-owl-nav">
			...
			<?php
				$idTL = $_GET['idTL'];
				$tinmoinhatTL = $db->tinMoiNhatTL(10, $idTL);
				foreach ($tinmoinhatTL as $row) {
			?>	
			<article class="article thumb-article">
				<div class="article-img">
					<img src="public/images/<?php echo $row['hinhAnh'] ?>" class="img-responsive" alt="" style="width: 100%; height: 400px;">
				</div>
					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="section-title">
									<?php
									$tinmoiTL = $db->tinMoiNhatTL(1,$idTL);
									foreach ($tinmoiTL as $row) {
									?>	
									<h2 class="title"><?php echo $row['tenTL'] ?></h2>
									<?php } ?>
								</div>
							</div>
							<!-- /section title -->
							...
							<?php
								$tinmoiTL = $db->tinMoiNhatTL1($idTL,6);
								foreach ($tinmoiTL as $row) {
							?>	
							<!-- Column 1 -->
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<div class="article-pagination">
							<ul> 
							<?php
								$base_url = $_SERVER['PHP_SELF'].'?idTL='.$idTL.'&';
